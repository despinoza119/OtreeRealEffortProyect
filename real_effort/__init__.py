...
class Results2(Page):
    ...
    def vars_for_template(player: Player):
        ...
        return dict(offer=monto[0] - group.kept)
...
class Process(Page):
    ...
    def vars_for_template(player):
        ...
        if (player_b.num_correct>mediana):
            a="SUPERÓ LA MEDIANA DEL TOTAL DE PUNTAJE DE LOS JUGADORES"
            monto[0]=100
            ...
            if(lista[0]==0):
                ...
                a="NO SUPERÓ LA MEDIANA DEL TOTAL DE PUNTAJE DE LOS JUGADORES"
                monto[0]=50
                lista[0]=0    
        else:
            a="NO SUPERÓ LA MEDIANA DEL TOTAL DE PUNTAJE DE LOS JUGADORES"
...
page_sequence = [Game,ResultsWaitPage,MyWaitPage,Results,Process,ResultsWaitPage,Results2]